...
const data = [
  ...
  {
    key: 'https://i.ytimg.com/vi/tx_KQxCeT9Y/movieposter_en.jpg',
  },
  {
  ...
  },
  {
    ...
    // key: 'https://img.extmovie.com/files/attach/images/135/543/683/025/799e45f15c6b2ff9085227de363f1b81.jpg',
    key: 'https://cloudfront-ap-northeast-1.images.arcpublishing.com/chosun/DSC6YWYLN3WJDEEZRMJLO6HOUE.jpg',
  },
  {
  ...
  render() {
    return (
      <SafeAreaView style={styles.full}>
        {/* <Text style={{color: 'white', fontSize: 20}}>SearchBar</Text> */}
        ...
        <Text style={styles.itemTitle}>컬렉션 둘러보기</Text>
        <FlatList
